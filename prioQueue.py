...
if __name__ == "__main__":
    ...
    # this will result in the 2 manual songs and 2 queue songs to play, then add the 2 more songs to queue
    ...
    # result
    #
    # playing song: Song 6    queue song
    # playing song: Song 7    queue song
    # playing song: Song 1    playlist song
    # playing song: Song 2    playlist song
    # playing song: Song 8    queue song
    # playing song: Song 9    queue song
